...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 24 mai 2023 à 11:59
...
INSERT INTO `question` (`id`, `title`, `creation_date`, `content`, `id_user`) VALUES
...
(3, 'Nommage des tables', '2023-01-30 00:00:00', 'Est ce qu\'il existe des conventions de nommages des tables / attributs dans le milieu professionnel de la base de donnés ?', 5),
(4, 'Table et relation', '2023-01-30 00:00:00', 'Bonjour, je me demandais quelle est la différence entre une table et une relation ?', 3),
(5, 'Nombre de relation', '2023-01-30 00:00:00', 'est-il possible d\'avoir deux ou plusieurs relations entre deux mêmes entités ?', 6),
(6, 'tuple et n-tuple', '2023-01-31 00:00:00', 'Que signifie \"tuple\" et \"n-uplet\" d\'un modèle ?', 7),
...
(8, 'Groupe by et Order by', '2023-02-14 00:00:00', 'Quelle est la différence entre GROUP BY et ORDER BY ?', 1),
...
(12, 'Usage des vues', '2023-02-27 00:00:00', 'Quels sont les désavantages d\'utiliser une vue au lieu d\'une table ?', 2);
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `profile_url` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
