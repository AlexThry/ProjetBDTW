...
if($answer === null ) AlertManager::display_warning( "Cette question n'a pas encore de réponse" );
    ...
    if ( key_exists( 'edit_answer', $_GET ) ) {
        ...
        $admin_image = $answer_user !== null && $answer_user->has_profile_url() ? $answer_user->get_profile_url() : "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80";
        ?>
