...
$genre  = isset( $_GET['category'] ) && ! empty( $_GET['category'] ) ? htmlentities( $_GET['category'] ) : null;
...
<form class="sm:max-w-lg w-450" action="<?= get_home_url(); ?>" method="GET">
    <div class="flex search-cat-dropdown-container">
        ...
        <div class="relative w-full">
            <input value="<?= isset( $search ) ? $search : ''; ?>" type="search" id="search-dropdown" name="search" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-lg border-l-gray-50 border-l-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-l-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Rechercher une question...">
